...
public class PlayingCard
{
    ...
    // parameter 'suit'
    /**
     * @param cardRank parameter to set rank field.
     * @param cardSuit parameter to set suit field.
     */
    public PlayingCard(SuitsAndRanks.Rank cardRank, SuitsAndRanks.Suit cardSuit)
    {
